...
export class ChannelServiceProxy {
     ...
     * @return Success
     */
    getAllUsersByChannel(channelId: number | undefined): Observable<UserDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Channel/GetAllUsersByChannel?";
        if (channelId === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllUsersByChannel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllUsersByChannel(<any>response_);
                } catch (e) {
    ...
    protected processGetAllUsersByChannel(response: HttpResponseBase): Observable<UserDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAllAvailableChannels(): Observable<ChannelDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Channel/GetAllAvailableChannels";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllAvailableChannels(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllAvailableChannels(<any>response_);
                } catch (e) {
    ...
    protected processGetAllAvailableChannels(response: HttpResponseBase): Observable<ChannelDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    createNewChannel(name: string | null | undefined): Observable<ChannelDto> {
        let url_ = this.baseUrl + "/api/services/app/Channel/CreateNewChannel?";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateNewChannel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateNewChannel(<any>response_);
                } catch (e) {
                    return <Observable<ChannelDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateNewChannel(response: HttpResponseBase): Observable<ChannelDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    createDMChannel(userId: number | undefined): Observable<ChannelDto> {
        let url_ = this.baseUrl + "/api/services/app/Channel/CreateDMChannel?";
        if (userId === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateDMChannel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateDMChannel(<any>response_);
                } catch (e) {
                    return <Observable<ChannelDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateDMChannel(response: HttpResponseBase): Observable<ChannelDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    isUserInChannel(user: number | null | undefined, channel: number | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Channel/IsUserInChannel?";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processIsUserInChannel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processIsUserInChannel(<any>response_);
                } catch (e) {
    ...
    protected processIsUserInChannel(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class MessageServiceProxy {
    ...
    /**
     * @param channelId (optional) 
     * @param lastMessage (optional) 
     * @return Success
     */
    getChannelHistory(channelId: number | undefined, lastMessage: number | undefined): Observable<MessageDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Message/GetChannelHistory?";
        if (channelId === null)
            throw new Error("The parameter 'channelId' cannot be null.");
        else if (channelId !== undefined)
            url_ += "channelId=" + encodeURIComponent("" + channelId) + "&";
        if (lastMessage === null)
            throw new Error("The parameter 'lastMessage' cannot be null.");
        else if (lastMessage !== undefined)
            url_ += "lastMessage=" + encodeURIComponent("" + lastMessage) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetChannelHistory(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetChannelHistory(<any>response_);
                } catch (e) {
    ...
    protected processGetChannelHistory(response: HttpResponseBase): Observable<MessageDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class TaskServiceProxy {
     ...
     * @return Success
     */
    getTasks(): Observable<MessageTask[]> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<MessageTask[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<MessageTask[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetTasks(response: HttpResponseBase): Observable<MessageTask[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(MessageTask.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return _observableOf<MessageTask[]>(<any>null);
    }

    /**
     * @return Success
     */
    getGivedTask(): Observable<MessageTask[]> {
        let url_ = this.baseUrl + "/api/services/app/Task/GetGivedTask";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetGivedTask(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetGivedTask(<any>response_);
                } catch (e) {
                    return <Observable<MessageTask[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetGivedTask(response: HttpResponseBase): Observable<MessageTask[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    deleteTask(taskId: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Task/DeleteTask?";
        if (taskId === null)
     ...
     * @return Success
     */
    markAsTask(messageId: number | undefined, userId: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Task/MarkAsTask?";
        if (messageId === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processMarkAsTask(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMarkAsTask(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processMarkAsTask(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    setCompleted(taskId: number | undefined, complete: boolean | undefined): Observable<MessageTask> {
        let url_ = this.baseUrl + "/api/services/app/Task/SetCompleted?";
        if (taskId === null)
            throw new Error("The parameter 'taskId' cannot be null.");
        else if (taskId !== undefined)
            url_ += "taskId=" + encodeURIComponent("" + taskId) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSetCompleted(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSetCompleted(<any>response_);
                } catch (e) {
                    return <Observable<MessageTask>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSetCompleted(response: HttpResponseBase): Observable<MessageTask> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MessageTask.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class ChannelDto implements IChannelDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.name = _data["name"];
            this.admin = _data["admin"] ? UserDto.fromJS(_data["admin"]) : <any>undefined;
            this.id = _data["id"];
        }
    }
...
export class Channel implements IChannel {
    ...
    init(_data?: any) {
        if (_data) {
            this.name = _data["name"];
            this.admin = _data["admin"] ? User.fromJS(_data["admin"]) : <any>undefined;
            this.id = _data["id"];
        }
    }
...
export class Emoji implements IEmoji {
    ...
    static fromJS(data: any): Emoji {
        data = typeof data === 'object' ? data : {};
        let result = new Emoji();
        result.init(data);
        return result;
    }
...
export class Message implements IMessage {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["emojis"])) {
                this.emojis = [] as any;
                for (let item of _data["emojis"])
                    this.emojis.push(Emoji.fromJS(item));
            }
            this.id = _data["id"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.emojis)) {
            data["emojis"] = [];
            for (let item of this.emojis)
                data["emojis"].push(item.toJSON());
        }
        data["id"] = this.id;
        return data; 
    }
...
export class MessageTask implements IMessageTask {
    ...
    static fromJS(data: any): MessageTask {
        data = typeof data === 'object' ? data : {};
        let result = new MessageTask();
        result.init(data);
        return result;
    }
